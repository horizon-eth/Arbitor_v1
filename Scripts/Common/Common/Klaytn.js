...
// EtherConverter
const native_token_symbol = "KLAY";
const native_token_address = "0xe4f05a66ec68b54a58b17c22107b02e0232cc817";
...
// ****************** ProjectsV2 ******************
const ProjectsV2 = {
	"DeFiKingdoms(Serendale)V2": {
		factoryAddress: ["0x36fAE766e51f17F8218C735f58426E293498Db2B"],
...
const ProjectsV3 = {
	KlayswapV3: {
		factoryAddress: ["0xA15Be7e90df29A4aeaD0C7Fc86f7a9fBe6502Ac9"],
...
const KlayswapV3_QuoterV4_Contract = new ethers.Contract(ProjectsV3["KlayswapV3"].quoterAddress, QuoterV4ABI, CONTRACT_PROVIDER);

const QuotersV3 = {
	KlayswapV3: KlayswapV3_QuoterV4_Contract,
};
