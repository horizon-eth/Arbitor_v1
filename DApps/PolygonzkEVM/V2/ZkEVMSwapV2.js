...
let USDT_WETH_POOL = {
	address: "0x7138C6603D371272281E24CE974ad8AA23abccc8",
	https_contract: new ethers.Contract("0x7138C6603D371272281E24CE974ad8AA23abccc8", poolABI, POOL_PROVIDER_V2),
	wss_contract: null,
	reserve0: undefined,
	reserve1: undefined,
	processing: false,
...
let USDT_MATIC_POOL = {
	address: "0x404ae659F793a37D83571F9F024dEa74cd61DF43",
	https_contract: new ethers.Contract("0x404ae659F793a37D83571F9F024dEa74cd61DF43", poolABI, POOL_PROVIDER_V2),
	wss_contract: null,
	reserve0: undefined,
	reserve1: undefined,
	processing: false,
...
let USDT_USDC_POOL = {
	address: "0xd3510070E4c1246aB43c35B6F8a16D419186aE99",
	https_contract: new ethers.Contract("0xd3510070E4c1246aB43c35B6F8a16D419186aE99", poolABI, POOL_PROVIDER_V2),
	wss_contract: null,
	reserve0: undefined,
	reserve1: undefined,
	processing: false,
...
let WETH_MATIC_POOL = {
	address: "0xd799cBa6c24231E34b35f48F5d209f4E5eeC02a4",
	https_contract: new ethers.Contract("0xd799cBa6c24231E34b35f48F5d209f4E5eeC02a4", poolABI, POOL_PROVIDER_V2),
	wss_contract: null,
	reserve0: undefined,
	reserve1: undefined,
	processing: false,
...
let WETH_USDC_POOL = {
	address: "0x0718811a2BeF79DD7f3baCc67A13a004bcF8a0B9",
	https_contract: new ethers.Contract("0x0718811a2BeF79DD7f3baCc67A13a004bcF8a0B9", poolABI, POOL_PROVIDER_V2),
	wss_contract: null,
	reserve0: undefined,
	reserve1: undefined,
	processing: false,
...
let WETH_DAI_POOL = {
	address: "0xc780d2aF58A2D5231838dF10767B10E01A4A1126",
	https_contract: new ethers.Contract("0xc780d2aF58A2D5231838dF10767B10E01A4A1126", poolABI, POOL_PROVIDER_V2),
	wss_contract: null,
	reserve0: undefined,
	reserve1: undefined,
	processing: false,
...
let WETH_WBTC_POOL = {
	address: "0x4c8FC85B0548DC1235FdC3f130C435457e6E5d87",
	https_contract: new ethers.Contract("0x4c8FC85B0548DC1235FdC3f130C435457e6E5d87", poolABI, POOL_PROVIDER_V2),
	wss_contract: null,
	reserve0: undefined,
	reserve1: undefined,
	processing: false,
...
let MATIC_USDC_POOL = {
	address: "0x6c992c726270c45bDab6DCBbFEf58F03dE266Fd2",
	https_contract: new ethers.Contract("0x6c992c726270c45bDab6DCBbFEf58F03dE266Fd2", poolABI, POOL_PROVIDER_V2),
	wss_contract: null,
	reserve0: undefined,
	reserve1: undefined,
	processing: false,
...
let MATIC_WBTC_POOL = {
	address: "0xFBCB3d438DFE187fB2a17532166fe33855598814",
	https_contract: new ethers.Contract("0xFBCB3d438DFE187fB2a17532166fe33855598814", poolABI, POOL_PROVIDER_V2),
	wss_contract: null,
	reserve0: undefined,
	reserve1: undefined,
	processing: false,
...
let USDC_DAI_POOL = {
	address: "0xc83EB7E87AeBAb0D64F5160CdD24d07D14D48fBF",
	https_contract: new ethers.Contract("0xc83EB7E87AeBAb0D64F5160CdD24d07D14D48fBF", poolABI, POOL_PROVIDER_V2),
	wss_contract: null,
	reserve0: undefined,
	reserve1: undefined,
	processing: false,
