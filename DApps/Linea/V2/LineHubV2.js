...
let WEETH_WETH_POOL = {
	address: "0x570698D03c5A3C7eEdA5D97dbaF5FBfa117E46B7",
	https_contract: new ethers.Contract("0x570698D03c5A3C7eEdA5D97dbaF5FBfa117E46B7", poolABI, POOL_PROVIDER_V2),
	wss_contract: null,
	reserve0: undefined,
	reserve1: undefined,
	processing: false,
...
let WEETH_EZETH_POOL = {
	address: "0xc1204D80cbA94Af9920733ccABB65Ae517aF05c1",
	https_contract: new ethers.Contract("0xc1204D80cbA94Af9920733ccABB65Ae517aF05c1", poolABI, POOL_PROVIDER_V2),
	wss_contract: null,
	reserve0: undefined,
	reserve1: undefined,
	processing: false,
...
let USDC_WETH_POOL = {
	address: "0xa8483Ca97eD1418cEc1b3b6Ab5DD0C80492DA331",
	https_contract: new ethers.Contract("0xa8483Ca97eD1418cEc1b3b6Ab5DD0C80492DA331", poolABI, POOL_PROVIDER_V2),
	wss_contract: null,
	reserve0: undefined,
	reserve1: undefined,
	processing: false,
...
let USDT_WETH_POOL = {
	address: "0xC267F235Dee51a87c095b4cDA1C4ceDeFD19Cbd2",
	https_contract: new ethers.Contract("0xC267F235Dee51a87c095b4cDA1C4ceDeFD19Cbd2", poolABI, POOL_PROVIDER_V2),
	wss_contract: null,
	reserve0: undefined,
	reserve1: undefined,
	processing: false,
...
let WSTETH_WETH_POOL = {
	address: "0x53Afa7A9bbd0b76b8fBb08Aac0196cffd0AAD575",
	https_contract: new ethers.Contract("0x53Afa7A9bbd0b76b8fBb08Aac0196cffd0AAD575", poolABI, POOL_PROVIDER_V2),
	wss_contract: null,
	reserve0: undefined,
	reserve1: undefined,
	processing: false,
...
let WBTC_WETH_POOL = {
	address: "0xe6679409181f2da2FC972963654923dfFCb825c9",
	https_contract: new ethers.Contract("0xe6679409181f2da2FC972963654923dfFCb825c9", poolABI, POOL_PROVIDER_V2),
	wss_contract: null,
	reserve0: undefined,
	reserve1: undefined,
	processing: false,
...
let MATIC_WETH_POOL = {
	address: "0x197684d63518240D8324ff94538F0C9e2d4f3dae",
	https_contract: new ethers.Contract("0x197684d63518240D8324ff94538F0C9e2d4f3dae", poolABI, POOL_PROVIDER_V2),
	wss_contract: null,
	reserve0: undefined,
	reserve1: undefined,
	processing: false,
...
let AVAX_WETH_POOL = {
	address: "0xc6571706B30E5282b1bBc2e1370A32E4A77f0A92",
	https_contract: new ethers.Contract("0xc6571706B30E5282b1bBc2e1370A32E4A77f0A92", poolABI, POOL_PROVIDER_V2),
	wss_contract: null,
	reserve0: undefined,
	reserve1: undefined,
	processing: false,
...
let USDC_USDT_POOL = {
	address: "0x3DA9882a864d55dcd690D7C348fc5baAce6174C2",
	https_contract: new ethers.Contract("0x3DA9882a864d55dcd690D7C348fc5baAce6174C2", poolABI, POOL_PROVIDER_V2),
	wss_contract: null,
	reserve0: undefined,
	reserve1: undefined,
	processing: false,
...
let USDC_WBTC_POOL = {
	address: "0xD1D556BaCBBcb5fdbc2185c95F4fFd1A5aC22cd8",
	https_contract: new ethers.Contract("0xD1D556BaCBBcb5fdbc2185c95F4fFd1A5aC22cd8", poolABI, POOL_PROVIDER_V2),
	wss_contract: null,
	reserve0: undefined,
	reserve1: undefined,
	processing: false,
...
let USDC_DAI_POOL = {
	address: "0x8865db315689144f54c5136004528f1ad81B25F0",
	https_contract: new ethers.Contract("0x8865db315689144f54c5136004528f1ad81B25F0", poolABI, POOL_PROVIDER_V2),
	wss_contract: null,
	reserve0: undefined,
	reserve1: undefined,
	processing: false,
...
let DAI_USDT_POOL = {
	address: "0x1b5C2b75eCe015304600704eb1Bd58B5292B66D7",
	https_contract: new ethers.Contract("0x1b5C2b75eCe015304600704eb1Bd58B5292B66D7", poolABI, POOL_PROVIDER_V2),
	wss_contract: null,
	reserve0: undefined,
	reserve1: undefined,
	processing: false,
...
let IZI_USDT_POOL = {
	address: "0xE13730e87888F7CD64d8B0e51A4E0D5022a107c0",
	https_contract: new ethers.Contract("0xE13730e87888F7CD64d8B0e51A4E0D5022a107c0", poolABI, POOL_PROVIDER_V2),
	wss_contract: null,
	reserve0: undefined,
	reserve1: undefined,
	processing: false,
...
let MATIC_WBTC_POOL = {
	address: "0xAEBF44C13FBe04f5CFC2c4ddD0A6b2e794099bbC",
	https_contract: new ethers.Contract("0xAEBF44C13FBe04f5CFC2c4ddD0A6b2e794099bbC", poolABI, POOL_PROVIDER_V2),
	wss_contract: null,
	reserve0: undefined,
	reserve1: undefined,
	processing: false,
...
let MVX_AVAX_POOL = {
	address: "0x480cCd907dC8d5c06400391a99c4638012723bC6",
	https_contract: new ethers.Contract("0x480cCd907dC8d5c06400391a99c4638012723bC6", poolABI, POOL_PROVIDER_V2),
	wss_contract: null,
	reserve0: undefined,
	reserve1: undefined,
	processing: false,
