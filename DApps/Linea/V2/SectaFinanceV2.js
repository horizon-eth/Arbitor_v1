...
let USDC_WETH_POOL = {
	address: "0xEcDbB2dA6BA86C84f364EBbd068561C8f383fE27",
	https_contract: new ethers.Contract("0xEcDbB2dA6BA86C84f364EBbd068561C8f383fE27", poolABI, POOL_PROVIDER_V2),
	wss_contract: null,
	reserve0: undefined,
	reserve1: undefined,
	processing: false,
...
let USDT_WETH_POOL = {
	address: "0xD9DB1363381cc9E7711B0EeB875156Eb41Cd5DE2",
	https_contract: new ethers.Contract("0xD9DB1363381cc9E7711B0EeB875156Eb41Cd5DE2", poolABI, POOL_PROVIDER_V2),
	wss_contract: null,
	reserve0: undefined,
	reserve1: undefined,
	processing: false,
...
let EZETH_WETH_POOL = {
	address: "0x224b1c4B64a59f10aE7c8b6A94Ee519586B31A35",
	https_contract: new ethers.Contract("0x224b1c4B64a59f10aE7c8b6A94Ee519586B31A35", poolABI, POOL_PROVIDER_V2),
	wss_contract: null,
	reserve0: undefined,
	reserve1: undefined,
	processing: false,
...
let WSTETH_WETH_POOL = {
	address: "0x72C7f40FF8715f9118EfB65D5374bd97b446ba64",
	https_contract: new ethers.Contract("0x72C7f40FF8715f9118EfB65D5374bd97b446ba64", poolABI, POOL_PROVIDER_V2),
	wss_contract: null,
	reserve0: undefined,
	reserve1: undefined,
	processing: false,
...
let WBTC_WETH_POOL = {
	address: "0x53249119571829ac9F21897eD4B1f740DdEbbF1f",
	https_contract: new ethers.Contract("0x53249119571829ac9F21897eD4B1f740DdEbbF1f", poolABI, POOL_PROVIDER_V2),
	wss_contract: null,
	reserve0: undefined,
	reserve1: undefined,
	processing: false,
...
let MENDI_WETH_POOL = {
	address: "0xb922ADB7ff19827656a653Af558ad964Ef261dfF",
	https_contract: new ethers.Contract("0xb922ADB7ff19827656a653Af558ad964Ef261dfF", poolABI, POOL_PROVIDER_V2),
	wss_contract: null,
	reserve0: undefined,
	reserve1: undefined,
	processing: false,
...
let LUBE_WETH_POOL = {
	address: "0xbd26a6b703eDAD9AbE251de31b24A97Bd3C930dD",
	https_contract: new ethers.Contract("0xbd26a6b703eDAD9AbE251de31b24A97Bd3C930dD", poolABI, POOL_PROVIDER_V2),
	wss_contract: null,
	reserve0: undefined,
	reserve1: undefined,
	processing: false,
...
let DAI_WETH_POOL = {
	address: "0x5b872317C3520b9AA2f2Eacb8717DD3D2D92D8A1",
	https_contract: new ethers.Contract("0x5b872317C3520b9AA2f2Eacb8717DD3D2D92D8A1", poolABI, POOL_PROVIDER_V2),
	wss_contract: null,
	reserve0: undefined,
	reserve1: undefined,
	processing: false,
...
let LINE_WETH_POOL = {
	address: "0xE54a65cbF941F535F0482E1238d7607e38101Fd6",
	https_contract: new ethers.Contract("0xE54a65cbF941F535F0482E1238d7607e38101Fd6", poolABI, POOL_PROVIDER_V2),
	wss_contract: null,
	reserve0: undefined,
	reserve1: undefined,
	processing: false,
...
let USDC_USDT_POOL = {
	address: "0x2192b90Fcb059F8a03B990e0466ADb7B9553b8B2",
	https_contract: new ethers.Contract("0x2192b90Fcb059F8a03B990e0466ADb7B9553b8B2", poolABI, POOL_PROVIDER_V2),
	wss_contract: null,
	reserve0: undefined,
	reserve1: undefined,
	processing: false,
...
let USDC_EZETH_POOL = {
	address: "0x89C4B657A9fF050D674e8E294885156Ecb4e895C",
	https_contract: new ethers.Contract("0x89C4B657A9fF050D674e8E294885156Ecb4e895C", poolABI, POOL_PROVIDER_V2),
	wss_contract: null,
	reserve0: undefined,
	reserve1: undefined,
	processing: false,
...
let USDC_LUBE_POOL = {
	address: "0x6B3692aFf9033175671Aa75728f1514Cda062883",
	https_contract: new ethers.Contract("0x6B3692aFf9033175671Aa75728f1514Cda062883", poolABI, POOL_PROVIDER_V2),
	wss_contract: null,
	reserve0: undefined,
	reserve1: undefined,
	processing: false,
...
let EZETH_USDT_POOL = {
	address: "0xFF09eF02AeA2fd047EffB9B8dfA65b9604cCEEE1",
	https_contract: new ethers.Contract("0xFF09eF02AeA2fd047EffB9B8dfA65b9604cCEEE1", poolABI, POOL_PROVIDER_V2),
	wss_contract: null,
	reserve0: undefined,
	reserve1: undefined,
	processing: false,
...
let WBTC_USDT_POOL = {
	address: "0x8BA230B4e0332f3eb54731aA4A89068b32158C15",
	https_contract: new ethers.Contract("0x8BA230B4e0332f3eb54731aA4A89068b32158C15", poolABI, POOL_PROVIDER_V2),
	wss_contract: null,
	reserve0: undefined,
	reserve1: undefined,
	processing: false,
...
let DAI_USDT_POOL = {
	address: "0x5A022ee7E58beB6D55bb2d83DC5f432047cdB806",
	https_contract: new ethers.Contract("0x5A022ee7E58beB6D55bb2d83DC5f432047cdB806", poolABI, POOL_PROVIDER_V2),
	wss_contract: null,
	reserve0: undefined,
	reserve1: undefined,
	processing: false,
...
let DAI_WSTETH_POOL = {
	address: "0x675beD08Ab83b6D7dd5aCFDd54783DFa08ca8753",
	https_contract: new ethers.Contract("0x675beD08Ab83b6D7dd5aCFDd54783DFa08ca8753", poolABI, POOL_PROVIDER_V2),
	wss_contract: null,
	reserve0: undefined,
	reserve1: undefined,
	processing: false,
...
let WBTC_DAI_POOL = {
	address: "0xAfdcC4f7223C6Cfc01Ef4CaFa6cfCE43137D3303",
	https_contract: new ethers.Contract("0xAfdcC4f7223C6Cfc01Ef4CaFa6cfCE43137D3303", poolABI, POOL_PROVIDER_V2),
	wss_contract: null,
	reserve0: undefined,
	reserve1: undefined,
	processing: false,
...
let LUBE_LINE_POOL = {
	address: "0x6AA582804c4d4985a921Ae1E50E245a1031060d2",
	https_contract: new ethers.Contract("0x6AA582804c4d4985a921Ae1E50E245a1031060d2", poolABI, POOL_PROVIDER_V2),
	wss_contract: null,
	reserve0: undefined,
	reserve1: undefined,
	processing: false,
