...
let USDC_WETH_POOL = {
	address: "0xB91A09d3794E815008194B0423802AF8359516Db",
	https_contract: new ethers.Contract("0xB91A09d3794E815008194B0423802AF8359516Db", poolABI, POOL_PROVIDER_V2),
	wss_contract: null,
	reserve0: undefined,
	reserve1: undefined,
	processing: false,
...
let USDT_WETH_POOL = {
	address: "0x687d9b3e896E02524f5D8a059E6fA8BEB403aE1D",
	https_contract: new ethers.Contract("0x687d9b3e896E02524f5D8a059E6fA8BEB403aE1D", poolABI, POOL_PROVIDER_V2),
	wss_contract: null,
	reserve0: undefined,
	reserve1: undefined,
	processing: false,
...
let EZETH_WETH_POOL = {
	address: "0x2d26c81A09E1300260Ac0A451F7F77606A1EED40",
	https_contract: new ethers.Contract("0x2d26c81A09E1300260Ac0A451F7F77606A1EED40", poolABI, POOL_PROVIDER_V2),
	wss_contract: null,
	reserve0: undefined,
	reserve1: undefined,
	processing: false,
...
let FOXY_WETH_POOL = {
	address: "0xF2076A83199097546daDEF599B8a66260dA3BD56",
	https_contract: new ethers.Contract("0xF2076A83199097546daDEF599B8a66260dA3BD56", poolABI, POOL_PROVIDER_V2),
	wss_contract: null,
	reserve0: undefined,
	reserve1: undefined,
	processing: false,
...
let WSTETH_WETH_POOL = {
	address: "0xEAd8F89Bc222b3d2D3FA25e7a8FC351c4C73FAfD",
	https_contract: new ethers.Contract("0xEAd8F89Bc222b3d2D3FA25e7a8FC351c4C73FAfD", poolABI, POOL_PROVIDER_V2),
	wss_contract: null,
	reserve0: undefined,
	reserve1: undefined,
	processing: false,
...
let WBTC_WETH_POOL = {
	address: "0x8d90629c88716BEF69Dd352E7D1F2fa3e2d3FEc3",
	https_contract: new ethers.Contract("0x8d90629c88716BEF69Dd352E7D1F2fa3e2d3FEc3", poolABI, POOL_PROVIDER_V2),
	wss_contract: null,
	reserve0: undefined,
	reserve1: undefined,
	processing: false,
...
let DAI_WETH_POOL = {
	address: "0x3c286bFAF89785a42815F356fBD5fE0d90b2F506",
	https_contract: new ethers.Contract("0x3c286bFAF89785a42815F356fBD5fE0d90b2F506", poolABI, POOL_PROVIDER_V2),
	wss_contract: null,
	reserve0: undefined,
	reserve1: undefined,
	processing: false,
...
let CAKE_WETH_POOL = {
	address: "0xA43384a3d1c6De03FD910d29109151EFc762979b",
	https_contract: new ethers.Contract("0xA43384a3d1c6De03FD910d29109151EFc762979b", poolABI, POOL_PROVIDER_V2),
	wss_contract: null,
	reserve0: undefined,
	reserve1: undefined,
	processing: false,
...
let WETH_BNB_POOL = {
	address: "0x85F0e820dCa021957e071E6733a5d94224039017",
	https_contract: new ethers.Contract("0x85F0e820dCa021957e071E6733a5d94224039017", poolABI, POOL_PROVIDER_V2),
	wss_contract: null,
	reserve0: undefined,
	reserve1: undefined,
	processing: false,
...
let ONEPUNCH_WETH_POOL = {
	...
	https_contract: new ethers.Contract("0x89E33c1952921A64Fb59994353d5C7b89eCDaDaD", poolABI, POOL_PROVIDER_V2),
	wss_contract: null,
	reserve0: undefined,
	reserve1: undefined,
	processing: false,
...
let USDC_USDT_POOL = {
	address: "0x59c2d3F9BD0d4b3BB5Ef6322fdDDAb91B1710c2c",
	https_contract: new ethers.Contract("0x59c2d3F9BD0d4b3BB5Ef6322fdDDAb91B1710c2c", poolABI, POOL_PROVIDER_V2),
	wss_contract: null,
	reserve0: undefined,
	reserve1: undefined,
	processing: false,
...
let USDC_AXLUSDC_POOL = {
	address: "0x9A1879E45383C2D51FA920451a53C0B8728048d9",
	https_contract: new ethers.Contract("0x9A1879E45383C2D51FA920451a53C0B8728048d9", poolABI, POOL_PROVIDER_V2),
	wss_contract: null,
	reserve0: undefined,
	reserve1: undefined,
	processing: false,
...
let USDC_DAI_POOL = {
	address: "0x293137e06b3e038863d9eB51f4d29D6a83Fb75E1",
	https_contract: new ethers.Contract("0x293137e06b3e038863d9eB51f4d29D6a83Fb75E1", poolABI, POOL_PROVIDER_V2),
	wss_contract: null,
	reserve0: undefined,
	reserve1: undefined,
	processing: false,
...
let CAKE_USDC_POOL = {
	address: "0x227Fe2C18Dd4535C52EaC1A0a85bE7850089EcdB",
	https_contract: new ethers.Contract("0x227Fe2C18Dd4535C52EaC1A0a85bE7850089EcdB", poolABI, POOL_PROVIDER_V2),
	wss_contract: null,
	reserve0: undefined,
	reserve1: undefined,
	processing: false,
...
let WBTC_USDT_POOL = {
	address: "0x917adBdEe1E0dE2c394680a3EB7A3FEcb15a2D17",
	https_contract: new ethers.Contract("0x917adBdEe1E0dE2c394680a3EB7A3FEcb15a2D17", poolABI, POOL_PROVIDER_V2),
	wss_contract: null,
	reserve0: undefined,
	reserve1: undefined,
	processing: false,
...
let DAI_USDT_POOL = {
	address: "0x73C0FA05d5BECd71D63C65aEE5406D278c849084",
	https_contract: new ethers.Contract("0x73C0FA05d5BECd71D63C65aEE5406D278c849084", poolABI, POOL_PROVIDER_V2),
	wss_contract: null,
	reserve0: undefined,
	reserve1: undefined,
	processing: false,
...
let CAKE_USDT_POOL = {
	address: "0x84ff4c301830711ca4fAfeA2018f7dC00978130d",
	https_contract: new ethers.Contract("0x84ff4c301830711ca4fAfeA2018f7dC00978130d", poolABI, POOL_PROVIDER_V2),
	wss_contract: null,
	reserve0: undefined,
	reserve1: undefined,
	processing: false,
...
let DAI_WSTETH_POOL = {
	address: "0xE019923611189aD73Cb7945DCB1f85c94ee72e49",
	https_contract: new ethers.Contract("0xE019923611189aD73Cb7945DCB1f85c94ee72e49", poolABI, POOL_PROVIDER_V2),
	wss_contract: null,
	reserve0: undefined,
	reserve1: undefined,
	processing: false,
...
let WBTC_DAI_POOL = {
	address: "0xf64C622008EC869Fe71c281051EFC22b8E3beDa1",
	https_contract: new ethers.Contract("0xf64C622008EC869Fe71c281051EFC22b8E3beDa1", poolABI, POOL_PROVIDER_V2),
	wss_contract: null,
	reserve0: undefined,
	reserve1: undefined,
	processing: false,
