...
let WSS_POOL_PROVIDER = new ethersV5.providers.WebSocketProvider(process.env.XLAYER_V2_WSS_POOL_PROVIDER_URL);

let heartbeatInterval;

let USDT_WOKB_POOL = {
	address: "0xC71f9e1DE80Eb505C0cB3bBf90ae6593130e5D25",
	https_contract: new ethers.Contract("0xC71f9e1DE80Eb505C0cB3bBf90ae6593130e5D25", poolABI, POOL_PROVIDER_V2),
	wss_contract: null,
	reserve0: undefined,
	reserve1: undefined,
	processing: false,
...
let USDT_WETH_POOL = {
	address: "0xbc5f0255f341054531e2dF6BA20aD46B8556985b",
	https_contract: new ethers.Contract("0xbc5f0255f341054531e2dF6BA20aD46B8556985b", poolABI, POOL_PROVIDER_V2),
	wss_contract: null,
	reserve0: undefined,
	reserve1: undefined,
	processing: false,
...
let USDT_USDC_POOL = {
	address: "0xc665706b4777E288901e915267b9d88161fe3Fe8",
	https_contract: new ethers.Contract("0xc665706b4777E288901e915267b9d88161fe3Fe8", poolABI, POOL_PROVIDER_V2),
	wss_contract: null,
	reserve0: undefined,
	reserve1: undefined,
	processing: false,
...
let WETH_WOKB_POOL = {
	address: "0xa8f060edDFbA0eF41810e4a9211F8b85B0f64a51",
	https_contract: new ethers.Contract("0xa8f060edDFbA0eF41810e4a9211F8b85B0f64a51", poolABI, POOL_PROVIDER_V2),
	wss_contract: null,
	reserve0: undefined,
	reserve1: undefined,
	processing: false,
...
let USDC_WOKB_POOL = {
	address: "0x8BC3b18232DCEa4E10eCbCDE6d56F2C68Fe1F3C7",
	https_contract: new ethers.Contract("0x8BC3b18232DCEa4E10eCbCDE6d56F2C68Fe1F3C7", poolABI, POOL_PROVIDER_V2),
	wss_contract: null,
	reserve0: undefined,
	reserve1: undefined,
	processing: false,
...
let PUFF_WOKB_POOL = {
	address: "0xAd71E567501633f96948cd46E4700799006D3D15",
	https_contract: new ethers.Contract("0xAd71E567501633f96948cd46E4700799006D3D15", poolABI, POOL_PROVIDER_V2),
	wss_contract: null,
	reserve0: undefined,
	reserve1: undefined,
	processing: false,
...
let OKBABY_WOKB_POOL = {
	address: "0xa0f752EAF34D574dd9dd3C7A821568DB90e676dd",
	https_contract: new ethers.Contract("0xa0f752EAF34D574dd9dd3C7A821568DB90e676dd", poolABI, POOL_PROVIDER_V2),
	wss_contract: null,
	reserve0: undefined,
	reserve1: undefined,
	processing: false,
...
let WETH_USDC_POOL = {
	address: "0x16c12eaD4932cF48f896dDb42377aac4F3d43906",
	https_contract: new ethers.Contract("0x16c12eaD4932cF48f896dDb42377aac4F3d43906", poolABI, POOL_PROVIDER_V2),
	wss_contract: null,
	reserve0: undefined,
	reserve1: undefined,
	processing: false,
...
async function Executor(pool) {
	...
	async function initialize() {
		async function getTokenMarketPrices() {
			try {
				[token0_Market_Price, token1_Market_Price, nativeToken_Market_Price] = await GlobalLibrary.getMarketPriceBatch([token0_symbol, token1_symbol, "OKB"]);
			} catch (error) {
...
async function Listen() {
	async function re_initialize() {
		for (const pool of poolsData) {
			...
			WSS_POOL_PROVIDER = new ethersV5.providers.WebSocketProvider(process.env.XLAYER_V2_WSS_POOL_PROVIDER_URL);
