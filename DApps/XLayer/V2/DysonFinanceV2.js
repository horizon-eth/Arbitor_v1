...
let USDC_WOKB_POOL = {
	address: "0x0d08A7eeD19343886D9960228870EeBb6F09459D",
	https_contract: new ethers.Contract("0x0d08A7eeD19343886D9960228870EeBb6F09459D", poolABI, POOL_PROVIDER_V2),
	wss_contract: null,
	reserve0: undefined,
	reserve1: undefined,
	feeRatio: undefined,
...
async function Executor(pool) {
	...
	const swapData =
		ZeroToOne == true ? project.swap0in + encoder.encode(["address", "uint256", "uint256"], [flashSwapAddress, amountIn, amountOutMin]).slice(2) : project.swap1in + encoder.encode(["address", "uint256", "uint256"], [flashSwapAddress, amountIn, amountOutMin]).slice(2);
