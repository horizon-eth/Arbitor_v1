...
let USDB_WETH_POOL = {
	address: "0xFB57c98d0a9Bd50c3a01862e47190a87426b28BB",
	https_contract: new ethers.Contract("0xFB57c98d0a9Bd50c3a01862e47190a87426b28BB", poolABI, POOL_PROVIDER_V2),
	wss_contract: null,
	reserve0: undefined,
	reserve1: undefined,
	processing: false,
...
let KAP_WETH_POOL = {
	address: "0x413A1Cdb8019a0729e6949412f4cAd67faEEbe53",
	https_contract: new ethers.Contract("0x413A1Cdb8019a0729e6949412f4cAd67faEEbe53", poolABI, POOL_PROVIDER_V2),
	wss_contract: null,
	reserve0: undefined,
	reserve1: undefined,
	processing: false,
...
let WETH_BND_POOL = {
	address: "0xCe5f294d5c591e6296D950D593BD58E65D05cF89",
	https_contract: new ethers.Contract("0xCe5f294d5c591e6296D950D593BD58E65D05cF89", poolABI, POOL_PROVIDER_V2),
	wss_contract: null,
	reserve0: undefined,
	reserve1: undefined,
	processing: false,
...
let BINU_WETH_POOL = {
	address: "0x3ed7B2F1040319d182d44B5F2C9642d91bcB9D33",
	https_contract: new ethers.Contract("0x3ed7B2F1040319d182d44B5F2C9642d91bcB9D33", poolABI, POOL_PROVIDER_V2),
	wss_contract: null,
	reserve0: undefined,
	reserve1: undefined,
	processing: false,
...
let WETH_HYPE_POOL = {
	address: "0x025B4215a5d415f0caB61d19C51Ef2A0C874536D",
	https_contract: new ethers.Contract("0x025B4215a5d415f0caB61d19C51Ef2A0C874536D", poolABI, POOL_PROVIDER_V2),
	wss_contract: null,
	reserve0: undefined,
	reserve1: undefined,
	processing: false,
...
let HOG_WETH_POOL = {
	address: "0xbeBF7905763e2b7cd69708e16d2e365f94E710a5",
	https_contract: new ethers.Contract("0xbeBF7905763e2b7cd69708e16d2e365f94E710a5", poolABI, POOL_PROVIDER_V2),
	wss_contract: null,
	reserve0: undefined,
	reserve1: undefined,
	processing: false,
...
let HOG_BLAST_POOL = {
	address: "0x07337d5F44ED31408a0D5D6DD96A9CBe08Cf6f43",
	https_contract: new ethers.Contract("0x07337d5F44ED31408a0D5D6DD96A9CBe08Cf6f43", poolABI, POOL_PROVIDER_V2),
	wss_contract: null,
	reserve0: undefined,
	reserve1: undefined,
	processing: false,
...
let HOG_PAC_POOL = {
	address: "0xCC0213AC6299f8e25aCE107E2bA936b3DAfA9881",
	https_contract: new ethers.Contract("0xCC0213AC6299f8e25aCE107E2bA936b3DAfA9881", poolABI, POOL_PROVIDER_V2),
	wss_contract: null,
	reserve0: undefined,
	reserve1: undefined,
	processing: false,
...
let USDB_HYPE_POOL = {
	address: "0x0A0d6485b120652463736ba02Af9D1010Fce4c78",
	https_contract: new ethers.Contract("0x0A0d6485b120652463736ba02Af9D1010Fce4c78", poolABI, POOL_PROVIDER_V2),
	wss_contract: null,
	reserve0: undefined,
	reserve1: undefined,
	processing: false,
...
let HOG_USDB_POOL = {
	address: "0x33CD6F75839d5e6B4e5DF3b68Ab2c10026f5691d",
	https_contract: new ethers.Contract("0x33CD6F75839d5e6B4e5DF3b68Ab2c10026f5691d", poolABI, POOL_PROVIDER_V2),
	wss_contract: null,
	reserve0: undefined,
	reserve1: undefined,
	processing: false,
...
let HOG_ANDY_POOL = {
	address: "0xC657EA15619B91c0712795CBa727d6338380441E",
	https_contract: new ethers.Contract("0xC657EA15619B91c0712795CBa727d6338380441E", poolABI, POOL_PROVIDER_V2),
	wss_contract: null,
	reserve0: undefined,
	reserve1: undefined,
	processing: false,
...
let HOG_WBTC_POOL = {
	address: "0x5dd1B2c677FB0065d35D91033d69eD47f7e9bf84",
	https_contract: new ethers.Contract("0x5dd1B2c677FB0065d35D91033d69eD47f7e9bf84", poolABI, POOL_PROVIDER_V2),
	wss_contract: null,
	reserve0: undefined,
	reserve1: undefined,
	processing: false,
...
let HOG_OFF_POOL = {
	address: "0x93dD34A5A1E09414b2e1E0F63e31c49E54C0085f",
	https_contract: new ethers.Contract("0x93dD34A5A1E09414b2e1E0F63e31c49E54C0085f", poolABI, POOL_PROVIDER_V2),
	wss_contract: null,
	reserve0: undefined,
	reserve1: undefined,
	processing: false,
...
let PEPE_HOG_POOL = {
	address: "0x7f09A2B6ab2201cbcB156289F8aE130AA7c3C128",
	https_contract: new ethers.Contract("0x7f09A2B6ab2201cbcB156289F8aE130AA7c3C128", poolABI, POOL_PROVIDER_V2),
	wss_contract: null,
	reserve0: undefined,
	reserve1: undefined,
	processing: false,
...
let HOG_HYPE_POOL = {
	address: "0xfD3a559d060FDB051b7a911af3b9703Ba9804B75",
	https_contract: new ethers.Contract("0xfD3a559d060FDB051b7a911af3b9703Ba9804B75", poolABI, POOL_PROVIDER_V2),
	wss_contract: null,
	reserve0: undefined,
	reserve1: undefined,
	processing: false,
